...
import { MatchmakerConnection } from './MatchmakerConnection';
...
if (options.use_matchmaker) {
    const matchmakerConnection = new MatchmakerConnection(
        signallingServer,
        options.matchmaker_address,
        Number(options.matchmaker_port),
        Number(options.matchmaker_retry_interval),
        Number(options.player_port),
        Number(options.https_port),
        options.https,
        options.public_ip
    );
}
